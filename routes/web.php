...
Route::get('/about', \App\Http\Livewire\AboutComponent::class);

Route::get('/sss', \App\Http\Livewire\SSSComponent::class);

Route::get('/communication', \App\Http\Livewire\CommunicationComponent::class);
