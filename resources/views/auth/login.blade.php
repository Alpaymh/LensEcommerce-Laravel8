                            ...
                            <div class="login-form form-item form-stl">
                                ...
                                <form name="frm-login" method="POST" action="{{ route('login') }}">
                                    ...
                                    <fieldset class="wrap-title">
                                        <h3 class="form-title">HESABINIZA GİRİŞ YAPIN</h3>
                                    </fieldset>
                                    <fieldset class="wrap-input">
                                        <label for="frm-login-uname">E-Mail:</label>
                                        <input type="email" id="frm-login-uname" name="email" value="{{ old('email') }}" placeholder="Lütfen E-posta Adresinizi Giriniz."
                                            required autofocus>
                                    </fieldset>
                                    <fieldset class="wrap-input">
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <a class="link-function left-position" href="{{ route('password.request') }}" title="Forgotten password?">Şifreni mi Unuttun?</a>
                                    </fieldset>
