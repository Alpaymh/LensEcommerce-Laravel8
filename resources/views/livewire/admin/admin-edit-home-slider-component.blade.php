                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('admin.homeslider') }}" class="btn btn-success pull-right">Tüm Sliderler</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" wire:submit.prevent="store">
                            <div class="form-group">
                                <label for="title" class="col-md-4 control-label">Başlık</label>
                                <div class="col-md-4">
                                    <input type="text" id="title" placeholder="Başlık" class="form-control input-md" wire:model="title">
                                    @error('title') <div class="error" style="color: red;">{{ $message }}</div> @enderror
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="sub-title" class="col-md-4 control-label">Alt Başlık</label>
                                <div class="col-md-4">
                                    <input type="text" id="sub-title" placeholder="Alt Başlık" class="form-control input-md" wire:model="subtitle">
                                    @error('subtitle') <div class="error" style="color: red;">{{ $message }}</div> @enderror
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="price" class="col-md-4 control-label">Fiyat</label>
                                <div class="col-md-4">
                                    <input type="text" id="price" placeholder="Fiyat" class="form-control input-md" wire:model="price">
                            ...
                            <div class="form-group">
                                <label for="image" class="col-md-4 control-label">Resim</label>
                            ...
                            <div class="form-group">
                                <label for="status" class="col-md-4 control-label">Durumu</label>
                                <div class="col-md-4">
