                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" wire:submit.prevent="store">
                            ...
                            <div class="form-group">
                                <label for="sub-title" class="col-md-4 control-label">Altbaşlık</label>
                                <div class="col-md-4">
                                    <input type="text" id="sub-title" placeholder="Altbaşlık    " class="form-control input-md" wire:model="subtitle">
