        ...
        <div class="container">
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>ÜRÜN DETAY</span></li>
                </ul>
            </div>
            <div class="row">
...
{{--                                    </li>--}}
                        ...
                        <div class="detail-info">
                            ...
                            @if($product->sale_price > 0.00  && $sale->status == 1 && $sale->sale_date > \Carbon\Carbon::now())
                                ...
                                <li class="service">
                                    <a class="link-to-service" href="#">
                                        ...
                                        <div class="right-content">
                                            ...
                                            <p class="desc">Alışverişlerinizde Kargo Ücretsizdir</p>
                                        </div>
                                    </a>
                                </li>
                                <li class="service">
                                    <a class="link-to-service" href="#">
                                        ...
                                        <div class="right-content">
                                            <b class="title">Güvenli Alışveriş</b>
                                            <p class="desc">Alışverişlerinizde Güvenlik Garantisi</p>
                                        </div>
                                    </a>
                                </li>
                                <li class="service">
                                    <a class="link-to-service" href="#">
                                        ...
                                        <div class="right-content">
                                            <b class="title">İade</b>
                                            <p class="desc">Bir Hafta İçinde Para İade Garantisi</p>
                                        </div>
                                    </a>
                                </li>
                            </ul>
